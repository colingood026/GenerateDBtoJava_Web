...
public class MybatisGeneratorToLocal {
    ...
    DBJavaBeanGenerator mybatisJavaBeanGenerator;
    ...
    public void generate(ConnDeatilVo connDetail) throws Exception {
        ...
        //
        List<DBJavaDataVo> javaDataVos = GetJavaDataByDBInfoUtil.getJavaDatas(connDetail);
        //
        ...
        if (location != null) {
            for (DBJavaDataVo vo : javaDataVos) {
